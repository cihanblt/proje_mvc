<div class="hero-unit">
    <h3>Daire Düzenleme Paneli</h3>
    <p>
    <form action="?go=daire_kaydet" method="post">
        <table cellpadding="4" cellspacing="4">
            <tr>
                <td>Daire Adý :</td>
                <td><input value="<?php echo $this->d_liste[0]['h_name'];?>" type="text" name="h_name" /></td>
            </tr>
            <tr>
                <td>Daire Numarasý :</td>
                <td><input value="<?php echo $this->d_liste[0]['h_number'];?>" type="text" name="h_number" /></td>
            </tr>
            <tr>
                <td>Site :</td>
