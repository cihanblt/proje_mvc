<div class="hero-unit">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class="td_en"><a href="?go=yonetici_detay&id=<?php echo $this->liste[$i]['id'];?>"><img title="Detay Görüntüle" class="icons" src="<?php echo URL;?>public/images/info.png" /></a></td>
            <td class="td_en"><a href="?go=yonetici_duzenle&id=<?php echo $this->liste[$i]['id'];?>"><img class="icons" title="Düzenle" src="<?php echo URL;?>public/images/edit.png" /></a></td>
